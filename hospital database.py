'''A program for hospital management system
 - - by Mohd Meraaz
contact - meraaz0809@gmail.com
'''
...
con=sqlcon.connect(host="localhost",user="root",password="rootroot")#connection to mysql 
cur=con.cursor()
...
def entry():
    ...
    cur.execute('insert into UserData values(%s,%s,%s,%s,%s,%s)',(p1,p2,p3,p4,p5,p6,))
    con.commit()
...
def get_apoint():
    ...
    if len(a)==0:
        ...
        L7=Label(root3,text=('Enter date in DMY format')).place(x=100,y=400)
...
def lst_doc():
    ...
    l=["Dr. sharma","Dr. Verma","Dr. Kumar","Dr. Khan","Dr. Kohli",
    "Dr. singh","Dr. Sidharth","Dr. tendulkar","Dr. Virat","Dr. Leo",
    'Dr. Irfan','Dr. John','Dr. Sanjay','Dr. Shahid']
...
def ser_avail():
    ...
    l5=Label(root5,text='To avail any of these please contact Meraaz ')
    l5.place(x=20,y=240)
...
root=Tk()
label=Label(root,text="CARE WITH LOVE  HOSPITAL",font="arial 40 bold",bg='light blue')
